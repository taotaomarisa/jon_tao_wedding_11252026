...
const activityChoices = [
  {
    id: 'catamaran',
    title: 'Catamaran + Reef Swim',
    description:
      'Cruise out into the bright blue water for snorkeling, music, and a celebratory island toast.',
  },
  {
    id: 'spa',
    title: 'Spa Morning + Pool Cabana',
    description:
      'A slower day with massages, ocean views, chilled fruit, and long poolside conversations.',
  },
  {
    id: 'explore',
    title: 'Island Explorer Afternoon',
    description:
      'Visit local beach corners, boutique stops, and scenic overlooks before dinner back at the villa.',
  },
];
...
const exploreCards = [
  {
    title: 'Grace Bay',
    description: 'A must for long beach walks, easy swimming, and postcard-level water color.',
  },
  {
    title: 'Sunset Cruise',
    description: 'Perfect for guests who want one more dressed-up island moment before the wedding.',
  },
  {
    title: 'Local Flavors',
    description: 'Fresh seafood, tropical cocktails, and small island spots worth sneaking away to try.',
  },
];
...
const stayCards = [
  {
    title: 'Wymara Villa',
    description:
      'The wedding weekend anchor with dramatic water views, private-villa energy, and easy access to all main events.',
  },
  {
    title: 'Nearby Resort Stay',
    description:
      'A great option for guests who want full resort amenities while staying close to the wedding celebrations.',
  },
  {
    title: 'Arrival Planning',
    description:
      'Aim to arrive by Nov 22 or early Nov 23 so you can settle in before the beach BBQ kickoff.',
  },
];

const navItems = ['home', 'schedule', 'food', 'activity', 'accommodation', 'explore'] as const;
...
export function WeddingExperience() {
  ...
  const [main, setMain] = useState(receptionMains[0]);
          ...
          >
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-2">
              <div className="group relative overflow-hidden rounded-[2rem] border border-[#d7e2f5] shadow-[0_20px_60px_rgba(95,134,199,0.14)]">
                <div className="absolute inset-0">
                  <Image
                    src="/turks-activity-horseback.webp"
                    alt="Activity inspiration in Turks and Caicos"
                    fill
                    className="object-cover transition duration-700 group-hover:scale-[1.03]"
                  />
                </div>
                <div className="relative min-h-[16rem] bg-[linear-gradient(180deg,rgba(17,31,54,0.08)_0%,rgba(17,31,54,0.12)_30%,rgba(17,31,54,0.28)_68%,rgba(17,31,54,0.56)_100%)] p-6">
                  <div className="max-w-sm rounded-[1.35rem] border border-white/12 bg-[rgba(11,24,43,0.16)] px-4 py-4 backdrop-blur-[2px]">
                    ...
                    <p className="mt-3 text-sm leading-7 text-white/84">
                      Pick the island plan that feels most like you, from relaxing to adventurous.
                    </p>
                  </div>
                </div>
      ...
      >
        ...
        <section id="food" className="mt-20 grid gap-6 xl:grid-cols-[1.02fr_0.98fr]">
          <div className="rounded-[2.25rem] border border-[#d9e4f6] bg-white p-7">
            ...
            <h2 className="mt-3 font-display text-5xl text-[#34557f]">Beach BBQ and reception dining</h2>
          ...
          <div className="rounded-[2.25rem] border border-[#d9e4f6] bg-[linear-gradient(180deg,#fffdfa,#f4f8ff)] p-7">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm uppercase tracking-[0.35em] text-[#5f86c7]">Reception Selection</p>
            </div>
            <h2 className="mt-3 font-display text-5xl text-[#34557f]">Update your dinner selection if needed</h2>
            ...
            <div className="mt-8 rounded-[1.5rem] border border-[#d8e2f4] bg-white px-5 py-4 text-sm text-slate-700">
              Add-on note: lobster is available as a seasonal add-on for the beef tenderloin option at
              $25 per person.
            </div>
        ...
        <section id="activity" className="mt-20 grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2.25rem] border border-[#d9e4f6] bg-white p-7">
            ...
            <h2 className="mt-3 font-display text-5xl text-[#34557f]">Choose your Nov 24 island plan.</h2>
              ...
              {activityChoices.map((option) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-lg font-semibold text-[#34557f]">{option.title}</p>
                      <p className="mt-2 text-sm leading-6 text-slate-700">{option.description}</p>
                    </div>
                    {activity === option.id ? (
                      <Check className="mt-1 h-5 w-5 text-[#5f86c7]" />
                    ) : (
          ...
          <div className="rounded-[2.25rem] border border-[#d9e4f6] bg-[linear-gradient(180deg,#45689d,#7e9fdb)] p-7 text-white">
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="rounded-[1.75rem] border border-white/18 bg-white/10 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-white/80">{selectedActivity.description}</p>
              </div>
              <div className="rounded-[1.75rem] border border-white/18 bg-white/10 p-5">
        ...
        <section id="accommodation" className="mt-20">
          <div className="mb-8 max-w-2xl">
            ...
            <h2 className="mt-3 font-display text-5xl text-[#34557f]">Stay close to the celebration and keep the weekend easy.</h2>
          </div>
          <div className="grid gap-5 lg:grid-cols-3">
            {stayCards.map((card) => (
              <article key={card.title} className="rounded-[2rem] border border-[#d9e4f6] bg-white p-6">
                <div className="flex items-center gap-3">
                  <BedDouble className="h-5 w-5 text-[#5f86c7]" />
                  <h3 className="text-xl font-semibold text-[#34557f]">{card.title}</h3>
                </div>
        ...
        <section id="explore" className="mt-20">
          <div className="mb-8 max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-5xl text-[#34557f]">Make the most of Turks and Caicos while you are here.</h2>
          </div>
          <div className="grid gap-5 lg:grid-cols-3">
            {exploreCards.map((card) => (
              <article key={card.title} className="rounded-[2rem] border border-[#d9e4f6] bg-white p-6">
                <div className="flex items-center gap-3">
                  <Compass className="h-5 w-5 text-[#5f86c7]" />
                  <h3 className="text-2xl font-semibold text-[#34557f]">{card.title}</h3>
                </div>
                <p className="mt-4 text-sm leading-7 text-slate-700">{card.description}</p>
              </article>
            ))}
        ...
        <section className="mt-20 rounded-[2.25rem] border border-[#d9e4f6] bg-[linear-gradient(135deg,#45689d,#7f9fd7)] px-8 py-8 text-white">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-white/70">AI Chat Included</p>
              <h2 className="mt-3 font-display text-5xl">Your guests can ask the website questions.</h2>
              <p className="mt-4 max-w-2xl text-base leading-8 text-white/82">
                The floating wedding concierge can answer questions about your schedule, menus, activity choices,
                where to stay, and what to explore. If OpenAI credentials are configured in this template, it can
                respond dynamically; otherwise it falls back to a wedding-aware local assistant response layer.
              </p>
            </div>
            <div className="rounded-[1.75rem] border border-white/15 bg-white/10 p-5 text-sm leading-7 text-white/84">
              <div className="flex items-center gap-2">
                <Palmtree className="h-5 w-5 text-[#f3d38b]" />
                Ask things like:
              </div>
              <div className="mt-3">“What happens on Nov 24?”</div>
              <div>“What are the vegetarian dinner options?”</div>
              <div>“Where should we stay near Wymara Villa?”</div>
            </div>
          </div>
        </section>
      </div>
